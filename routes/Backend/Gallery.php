...
#Route::get('gallery/{id}', 'Gallery\AdminGalleryController@showImages')->name('gallery.images');
...
Route::post('gallery/ajax-delete-album', 'Gallery\AdminGalleryController@deleteAlbum')->name('gallery.ajax-delete-album');
